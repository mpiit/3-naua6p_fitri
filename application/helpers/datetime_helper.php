...
function all_hari()
{
	$hari = array('0', 'Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat');
	return $hari;
}

function allKelas($id_kelas)
{
	$ci = &get_instance();
	$query = $ci->db->select('id_kelas')
...
function all_jam()
{
	$jam = array('07.00-08.00', '08.00-09.00', '09.00-10.00', '10.00-11.00', '11.00-12.00', '12.00-13.00', '13.00-14.00', '14.00-15.00', '15.00-16.00', '16.00-17.00', '17.00-18.00');
	return $jam;
}
